    ...
    },
    {
        ...
        topics: [
            ...
            },
            {
                ...
                content: `
                    <h4><strong>Công dụng:</strong></h4>
                    <p>Dùng để rút gọn câu, cung cấp thông tin một cách ngắn gọn.</p>
                    <ul>
                        <li><strong>Hiện tại phân từ (V-ing):</strong> Hành động chủ động.</li>
                        <li><strong>Quá khứ phân từ (V3/V-ed):</strong> Hành động bị động.</li>
                    </ul>
                    <h4><strong>Ví dụ:</strong></h4>
