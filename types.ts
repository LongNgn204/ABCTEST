...
export interface DailyGoal {
  id: string;
  description: string;
  type: 'learn_new' | 'review_srs' | 'complete_quiz' | 'complete_listening' | 'complete_conversation' | 'complete_pronunciation' | 'complete_story' | 'complete_adv_grammar' | 'complete_reading' | 'complete_writing' | 'complete_roleplay' | 'complete_challenge';
  target: number;
  current: number;
}
...
export type ViewMode = 'list' | 'flashcard' | 'quiz' | 'story' | 'dashboard' | 'conversation' | 'placement-test' | 'placement-test-result' | 'pronunciation' | 'grammar' | 'listening' | 'advanced-grammar' | 'auth' | 'reading' | 'writing' | 'role-play' | 'welcome' | 'landing' | 'leaderboard' | 'challenges';
